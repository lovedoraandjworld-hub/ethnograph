...
/* ===== DESKTOP / GITHUB PAGES LAYOUT FIX ===== */
#ethnocode-app{width:100vw;max-width:none!important;position:relative;left:50%;margin-left:-50vw;background:var(--bg);overflow:hidden}
#ethnocode-app *{box-sizing:border-box}
html,body{width:100%;max-width:none!important;min-height:100%;overflow-x:hidden}
body{margin:0!important;padding:0!important}
.header{
  width:100%;height:82px;padding:0 clamp(24px,3vw,58px);gap:clamp(18px,2vw,34px);
  border-radius:0!important;box-sizing:border-box;
}
.brand{min-width:195px;flex:0 0 auto}.nav{gap:clamp(16px,1.7vw,30px);white-space:nowrap}
.search{width:clamp(220px,22vw,390px);min-width:0}.header .primary{white-space:nowrap}
.hero{min-height:calc(100vh - 82px);padding:46px clamp(24px,3vw,58px) 54px;display:flex;align-items:center}
.hero-grid{width:100%;max-width:1600px;grid-template-columns:minmax(330px,430px) minmax(0,1fr);gap:clamp(34px,4vw,72px);align-items:center}
.hero-copy{min-width:0}.hero-copy h1{font-size:clamp(48px,4.1vw,72px);line-height:1.02;letter-spacing:.015em}
.hero-copy p{font-size:clamp(16px,1.15vw,19px);max-width:430px}
.stats-strip{margin-top:34px}.stat{min-width:0;padding:18px 8px}.stat b{font-size:clamp(22px,1.7vw,29px)}
.map-art{height:min(70vh,690px);min-height:560px;border-radius:4px;border:1px solid rgba(183,144,87,.48);box-shadow:10px 10px 0 rgba(0,0,0,.25),inset 0 0 0 1px rgba(255,255,255,.025)}
.artifact{width:74px;height:74px;border-radius:3px}.artifact small{top:78px}
.hero-tip{bottom:24px;border-radius:2px}
.section{width:100%;max-width:1600px;padding:72px clamp(24px,3vw,58px)}
.map-layout{grid-template-columns:minmax(0,1fr) 370px;gap:24px}.map-container{height:650px;border-radius:4px}.panel{border-radius:3px}
.object-modal-grid{grid-template-columns:minmax(0,1.25fr) minmax(360px,.75fr)}
.modal{max-width:min(1380px,94vw)}

/* Pixel museum treatment: straighter geometry, less app-like rounding */
.btn,.search,.input,.select,.primary,.panel,.stats-strip,.stat,.modal,.origin,.voice,.similar-card{border-radius:2px!important}

@media (max-width:1280px){
  .header{padding:0 22px;gap:16px}.brand{min-width:170px}.brand-sub{display:none}.nav{gap:14px}.nav a{font-size:12px}.search{width:220px}
  .hero{padding:42px 30px 48px}.hero-grid{grid-template-columns:360px minmax(0,1fr);gap:32px}.hero-copy h1{font-size:52px}.map-art{min-height:520px;height:600px}
}
@media (max-width:1050px){
  .nav a:nth-child(3),.nav a:nth-child(4),.nav a:nth-child(5){display:none}.search{width:200px}
  .hero-grid{grid-template-columns:1fr}.hero{min-height:auto}.hero-copy{max-width:720px}.map-art{height:560px}.map-layout{grid-template-columns:1fr}.sidebar{display:grid;grid-template-columns:1fr 1fr}.object-modal-grid{grid-template-columns:1fr}
}
@media (max-width:720px){
  .header{height:auto;min-height:70px;flex-wrap:wrap;padding:12px 16px}.nav{order:3;width:100%;overflow:auto}.search{display:none}.header .primary{padding:9px 11px}.hero{padding:38px 18px}.hero-copy h1{font-size:42px}.stats-strip{grid-template-columns:1fr 1fr}.stat:nth-child(2){border-right:0}.map-art{height:460px;min-height:460px}.section{padding:54px 18px}.sidebar{grid-template-columns:1fr}.map-container{height:520px}
}

</style>
</head>
<body>
<div id="ethnocode-app"><header class="header">
